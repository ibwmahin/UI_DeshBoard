...
const ecommerce = () => {
  ...
  return (
    <section>
      ...
      {/* Fourth Row - Recent Transactions and Top Projects */}
      <div className="grid grid-cols-1 sm:grid-cols-[32%_68%] md:grid-cols-[32%_25%_25%] justify-center mx-20 gap-6 p-6">
              ...
              <tr className="border-t dark:border-gray-700">
                <td className="p-2 flex items-center">
                  <img
                    ...
                    className="w-6 h-6 mr-2"
                  />
                  <span className="dark:text-white">Gaming Console</span>
                </td>
                <td className="p-2 text-center dark:text-white">78.5%</td>
                <td className="p-2 text-center ">
                  <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">
                    Low
                  </span>
                </td>
                <td className="p-2 text-right dark:text-white">$3.9k</td>
              </tr>
              <tr className="border-t dark:border-gray-700">
                <td className="p-2 flex items-center">
                  <img
                    ...
                    className="w-6 h-6 mr-2"
                  />
                  <span className="dark:text-white">Leather Purse</span>
                </td>
                <td className="p-2 text-center dark:text-white">58.6%</td>
                <td className="p-2 text-center">
                  <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs">
                    Medium
                  </span>
                </td>
                <td className="p-2 text-right dark:text-white">$3.5k</td>
              </tr>
              <tr className="border-t dark:border-gray-700">
                <td className="p-2 flex items-center">
                  <img
                    ...
                    className="w-6 h-6 mr-2"
                  />
                  <span className="dark:text-white">Red Velvet Dress</span>
                </td>
                <td className="p-2 text-center dark:text-white">25%</td>
                <td className="p-2 text-center">
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">
                    High
                  </span>
                </td>
                <td className="p-2 text-right dark:text-white">$3.8k</td>
              </tr>
              <tr className="border-t dark:border-gray-700">
                <td className="p-2 flex items-center">
                  <img
                    ...
                    className="w-6 h-6 mr-2"
                  />
                  <span className="dark:text-white">Headphone Boat</span>
                </td>
                <td className="p-2 text-center dark:text-white">9.3%</td>
                <td className="p-2 text-center">
                  <span className="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs">
                    Critical
                  </span>
                </td>
                <td className="p-2 text-right dark:text-white">$3.54k</td>
              </tr>
            </tbody>
          </table>
        </div>
